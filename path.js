...
<div class="row">
    <div class="col-2 offset-1 d-flex justify-content-end align-items-center border_color_top">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" id="molecule"
            height="fit-content">
            <path fill="#81A3A7"
                d="M11.76 14.76a1 1 0 0 1-.71-.29L5.7 9.12A1 1 0 0 1 7.12 7.7l5.35 5.35a1 1 0 0 1-.71 1.71zm9.17.83a1 1 0 0 1-.57-1.82l4.19-2.91a1 1 0 1 1 1.14 1.64l-4.19 2.91a1 1 0 0 1-.57.18z">
            </path>
            <path fill="#585A56"
                d="M5 4a3 3 0 0 0-3 3 3 3 0 0 0 3 3 3 3 0 0 0 3-3 3 3 0 0 0-3-3Z">
            </path>
            <path fill="#81A3A7"
                d="M20.93 15.59a1 1 0 0 1-.57-1.82l4.19-2.91a1 1 0 1 1 1.14 1.64l-4.19 2.91a1 1 0 0 1-.57.18Z">
            </path>
            <path fill="#81A3A7"
                d="M6.88 25.32a1 1 0 0 1-.57-1.82l4.19-2.91a1 1 0 1 1 1.14 1.64l-4.19 2.91a1 1 0 0 1-.57.18Z">
            </path>
            <path fill="#585A56"
                d="M11.06 13A7 7 0 0 0 16 25V11a6.91 6.91 0 0 0-4.94 2zm10.69 1A7 7 0 0 0 16 11v14a7 7 0 0 0 5.75-11z">
            </path>
            <path fill="#F1F3F2"
                d="M29 8.74A3 3 0 0 0 27 8a3 3 0 0 0-3 3 2.88 2.88 0 0 0 .18 1A3 3 0 0 0 30 11a2.94 2.94 0 0 0-1-2.26Z">
            </path>
            <path fill="#272424" d="M21.75 14A7 7 0 0 0 16 11v14a7 7 0 0 0 5.75-11Z">
            </path>
            <path fill="#585A56"
                d="M7.82 24A3 3 0 0 0 2 25a2.94 2.94 0 0 0 1 2.26A3 3 0 0 0 5 28a3 3 0 0 0 3-3 2.87 2.87 0 0 0-.18-1Z">
            </path>
            <path fill="#272424"
                d="M29 8.74A3 3 0 0 0 27 8a3 3 0 0 0-3 3 2.88 2.88 0 0 0 .18 1A3 3 0 0 0 30 11a2.94 2.94 0 0 0-1-2.26Z">
            </path>
    ...
    <div class="col-2 d-flex justify-content-start align-items-center border_color_top">
